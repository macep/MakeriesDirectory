...
const cdnClient = (isProd) ? 'http://justgotmade.com' : '/assets'
const fs = require('fs')
...
let allowCrossDomain = function(req, res, next) {
    res.header('Access-Control-Allow-Origin', 'justgotmade.com')
...
let cacheControl = function(req, res, next) {
  if (isProd) {
...
let strictTransportSecurity = function(req, res, next) {
